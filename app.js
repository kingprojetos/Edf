...
const bancos = {
    educacao_fisica: [
        ...
        { q: "22. Qual cor caracteriza a Cédula do graduado em Licenciatura?", options: ["Verde.", "Azul (ou indicação específica de Licenciatura).", "Vermelha.", "Amarela.", "Branca."], a: 1 },
    ...
    biologia_celular: [
        ...
        { q: "12. O complexo golgiense atua em:", options: ["Proteínas", "Digestão", "Empacotamento e secreção", "Energia", "Replicação"], a: 2 },
